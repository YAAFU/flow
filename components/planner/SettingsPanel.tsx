  ...
  return <div className="flow-form flow-stagger space-y-5">
    ...
    <section className="flow-card scroll-mt-4 rounded-2xl p-4" aria-labelledby="flow-help-heading">
      ...
      <div className="mt-3 grid gap-2">
        ...
        <HelpAction icon={<Sparkles size={17}/>} label="เปิด Core Tour" description="ดู Now / Next การจัดวัน และ Timeline แบบสั้น" onClick={onStartCoreTour}/>
      ...
      {!confirmingReset
        ...
        : <div role="group" aria-label="ยืนยันรีเซ็ตสถานะคำแนะนำ" className="mt-3 rounded-xl border-[1.5px] border-[var(--flow-ink)] p-3">
          ...
          <p className="mt-1 text-xs leading-5 text-[var(--flow-muted)]">ระบบจะล้างเฉพาะความคืบหน้า Guide และทัวร์ ไม่ลบงาน หมวดหมู่ หรือการตั้งค่าอื่น</p>
